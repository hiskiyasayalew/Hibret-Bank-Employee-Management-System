...
import com.project.book.Repository.EmployeeRepo;
        ...
        public class EmployeeService {
            ...
            public void deleteEmployee(Long id) {
                ...
                // Delete related appeals data first
                appealRepo.deleteByEmployee(employee);  // Delete appeals referencing this employee
        
                // Then delete related attendance data
                attendanceRepo.deleteByEmployee(employee);  // Delete attendance referencing this employee
